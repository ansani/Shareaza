...
class CDownloadTransferHTTPS : public CDownloadTransfer
{
// Construction
public:
	CDownloadTransferHTTPS(CDownloadSource* pSource);
	virtual ~CDownloadTransferHTTPS();
