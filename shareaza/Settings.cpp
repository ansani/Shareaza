...
void CSettings::Load() {
  ...
  Add(_T(""), _T("DiskSpaceStop"), &General.DiskSpaceStop, 25, 1, 0, 1000,
      _T(" M"));
  Add(_T(""), _T("DiskSpaceWarning"), &General.DiskSpaceWarning, 500, 1, 5,
      2000, _T(" M"));
  Add(_T(""), _T("HashIntegrity"), &General.HashIntegrity, true);
  Add(_T(""), _T("ItWasLimited"), &General.ItWasLimited, false, true);
  Add(_T(""), _T("MaxDebugLogSize"), &General.MaxDebugLogSize, 10 * Mega, Mega,
      0, 100, _T(" MB"));
  Add(_T(""), _T("MinTransfersRest"), &General.MinTransfersRest, 50, 1, 1, 100,
      _T(" ms"));
  Add(_T(""), _T("Path"), &General.Path);
  Add(_T(""), _T("LogLevel"), &General.LogLevel, MSG_INFO, 1, MSG_ERROR,
      MSG_DEBUG, _T(" level"));
  ...
  Add(_T("Settings"), _T("SearchPanelResults"), &General.SearchPanelResults,
      true);
  ...
  Add(_T("VersionCheck"), _T("UpdateCheckURL"), &VersionCheck.UpdateCheckURL,
      WEB_SITE_T _T("version"));
  ...
  Add(_T("Interface"), _T("TipDelay"), &Interface.TipDelay, 600, 1, 100, 5000,
      _T(" ms"));
  ...
  Add(_T("Interface"), _T("SearchWindowsLimit"), &Interface.SearchWindowsLimit,
      10, 1, 0, 50, _T(" windows"));
  Add(_T("Interface"), _T("BrowseWindowsLimit"), &Interface.BrowseWindowsLimit,
      10, 1, 0, 50, _T(" windows"));
  ...
  Add(_T("Fonts"), _T("PacketDumpFont"), &Fonts.PacketDumpFont, NULL, false,
      setFont);
  Add(_T("Fonts"), _T("SystemLogFont"), &Fonts.SystemLogFont, NULL, false,
      setFont);
  Add(_T("Fonts"), _T("FontSize"), &Fonts.FontSize, 11, 1, 8, 48, _T(" px"));

  Add(_T("Library"), _T("CreateGhosts"), &Library.CreateGhosts, true);
  Add(_T("Library"), _T("GhostLimit"), &Library.GhostLimit, 1000, 1, 0, 100000,
      _T(" files"));
  ...
  Add(_T("Library"), _T("HighPriorityHashing"), &Library.HighPriorityHashing,
      20, 1, 1, 100, _T(" MB/s"));
  Add(_T("Library"), _T("HistoryDays"), &Library.HistoryDays, 3, 1, 0, 365,
      _T(" days"));
  Add(_T("Library"), _T("HistoryTotal"), &Library.HistoryTotal, 32, 1, 0, 100,
      _T(" files"));
  Add(_T("Library"), _T("LowPriorityHashing"), &Library.LowPriorityHashing, 2,
      1, 1, 100, _T(" MB/s"));
  Add(_T("Library"), _T("MarkFileAsDownload"), &Library.MarkFileAsDownload,
      true);
  Add(_T("Library"), _T("MaxMaliciousFileSize"), &Library.MaxMaliciousFileSize,
      Kilo, 1, Kilo, 5 * Kilo, _T(" B"));
  Add(_T("Library"), _T("PanelSize"), &Library.PanelSize, 146, 1, 0, 1024,
      _T(" px"));
  Add(_T("Library"), _T("PrivateTypes"), &Library.PrivateTypes,
      _T("|dtapart|kdbx|ps1|ps1xml|ps2|ps2xml|psc1|psc2|ws|wsf|wsc|wsh|scf|vb|")
      _T("vbs|vbe|js|jse|hta|scr|application|jc!|fb!|bc!|!ut|dbx|part|partial|")
      _T("crdownload|pst|reget|getright|pif|lnk|sd|url|wab|infodb|racestats|")
      _T("chk|tmp|temp|ini|inf|log|old|manifest|met|bak|$$$|---|~~~|###|__")
      _T("incomplete___|"));
  Add(_T("Library"), _T("QueryRouteSize"), &Library.QueryRouteSize, 20, 1, 8,
      24);
  ...
  Add(_T("Library"), _T("SourceExpire"), &Library.SourceExpire, 24 * 60 * 60,
      60, 60, 7 * 24 * 60 * 60, _T(" m"));
  Add(_T("Library"), _T("SourceMesh"), &Library.SourceMesh, true);
  Add(_T("Library"), _T("StoreViews"), &Library.StoreViews, true);
  Add(_T("Library"), _T("ThumbSize"), &Library.ThumbSize, 128, 1, 16, 256,
      _T(" px"));
  Add(_T("Library"), _T("TigerHeight"), &Library.TigerHeight, 9, 1, 1, 64);
  Add(_T("Library"), _T("TreeSize"), &Library.TreeSize, 200, 1, 0, 1024,
      _T(" px"));
  ...
  Add(_T("Library"), _T("WatchFoldersTimeout"), &Library.WatchFoldersTimeout, 5,
      1, 1, 60, _T(" s"));
  Add(_T("Library"), _T("SmartSeriesDetection"), &Library.SmartSeriesDetection,
      true);
  Add(_T("Library"), _T("LastUsedView"), &Library.LastUsedView);
  Add(_T("Library"), _T("URLExportFormat"), &Library.URLExportFormat,
      _T("<a ")
      _T("href=\"magnet:?xt=urn:bitprint:[SHA1].[TIGER]&amp;xt=urn:ed2khash:[")
      _T("ED2K]&amp;xt=urn:md5:[MD5]&amp;xl=[ByteSize]&amp;dn=[NameURI]\">[")
      _T("Name]</a><br>"));
  ...
  Add(_T("Search"), _T("BlankSchemaURI"), &Search.BlankSchemaURI,
      CSchema::uriAudio);
  ...
  Add(_T("Search"), _T("LowestPriorityThrottle"),
      &Search.LowestPriorityThrottle, 30000, 1000, 1, 120, _T(" s"));
  Add(_T("Search"), _T("MediumPriorityThrottle"),
      &Search.MediumPriorityThrottle, 800, 1, 100, 5000, _T(" ms"));
  Add(_T("Search"), _T("GeneralThrottle"), &Search.GeneralThrottle, 200, 1, 200,
      1000, _T(" ms"));
  ...
  Add(_T("Search"), _T("MaxPreviewLength"), &Search.MaxPreviewLength, 20 * Kilo,
      Kilo, 1, 4 * Kilo, _T(" KB"));
  Add(_T("Search"), _T("MonitorFilter"), &Search.MonitorFilter);
  Add(_T("Search"), _T("MonitorQueue"), &Search.MonitorQueue, 128, 1, 1, 4096);
  Add(_T("Search"), _T("MonitorSchemaURI"), &Search.MonitorSchemaURI,
      CSchema::uriAudio);
  ...
  Add(_T("Search"), _T("SpamFilterThreshold"), &Search.SpamFilterThreshold, 20,
      1, 0, 100, _T("%"));
  ...
  Add(_T("MediaPlayer"), _T("AviPreviewCLSID"), &MediaPlayer.AviPreviewCLSID,
      _T("{394011F0-6D5C-42a3-96C6-24B9AD6B010C}"));
  Add(_T("MediaPlayer"), _T("EnableEnqueue"), &MediaPlayer.EnableEnqueue,
      false);
  ...
  Add(_T("MediaPlayer"), _T("MediaServicesCLSID"),
      &MediaPlayer.MediaServicesCLSID,
      _T("{3DC28AA6-A597-4E03-96DF-ADA19155B0BE}"));
  Add(_T("MediaPlayer"), _T("Mp3PreviewCLSID"), &MediaPlayer.Mp3PreviewCLSID,
      _T("{BF00DBCC-90A2-4f46-8171-7D4F929D035F}"));
  Add(_T("MediaPlayer"), _T("Mpeg1PreviewCLSID"),
      &MediaPlayer.Mpeg1PreviewCLSID,
      _T("{9AA8DF47-B8FE-47da-AB1A-2DAA0DA0B646}"));
  ...
  Add(_T("MediaPlayer"), _T("VisCLSID"), &MediaPlayer.VisCLSID,
      _T("{591A5CFF-3172-4020-A067-238542DDE9C2}"));
  Add(_T("MediaPlayer"), _T("VisPath"), &MediaPlayer.VisPath);
  Add(_T("MediaPlayer"), _T("VisSize"), &MediaPlayer.VisSize, 1);
  Add(_T("MediaPlayer"), _T("VisSoniqueCLSID"), &MediaPlayer.VisSoniqueCLSID,
      _T("{D07E630D-A850-4f11-AD29-3D3848B67EFE}"));
  Add(_T("MediaPlayer"), _T("VisWrapperCLSID"), &MediaPlayer.VisWrapperCLSID,
      _T("{C3B7B25C-6B8B-481A-BC48-59F9A6F7B69A}"));
  ...
  Add(_T("Connection"), _T("ConnectThrottle"), &Connection.ConnectThrottle, 250,
      1, 0, 5000, _T(" ms"));
  Add(_T("Connection"), _T("DeleteFirewallException"),
      &Connection.DeleteFirewallException, false);
  Add(_T("Connection"), _T("DeleteUPnPPorts"), &Connection.DeleteUPnPPorts,
      true);
  Add(_T("Connection"), _T("DetectConnectionLoss"),
      &Connection.DetectConnectionLoss, true);
  Add(_T("Connection"), _T("DetectConnectionReset"),
      &Connection.DetectConnectionReset, false);
  Add(_T("Connection"), _T("EnableFirewallException"),
      &Connection.EnableFirewallException, true);
  Add(_T("Connection"), _T("EnableUPnP"), &Connection.EnableUPnP, true);
  Add(_T("Connection"), _T("FailureLimit"), &Connection.FailureLimit, 3, 1, 1,
      512);
  Add(_T("Connection"), _T("FailurePenalty"), &Connection.FailurePenalty, 300,
      1, 30, 3600, _T(" s"));
  Add(_T("Connection"), _T("FirewallState"), &Connection.FirewallState,
      CONNECTION_AUTO, 1, CONNECTION_AUTO, CONNECTION_OPEN_UDPONLY);
  Add(_T("Connection"), _T("ForceConnectedState"),
      &Connection.ForceConnectedState, true);
  ...
  Add(_T("Connection"), _T("InPort"), &Connection.InPort,
      protocolPorts[PROTOCOL_G2], 1, 1, 65535);
#ifdef LAN_MODE
  ...
  Add(_T("Connection"), _T("RequireForTransfers"),
      &Connection.RequireForTransfers, true);
  Add(_T("Connection"), _T("Reuse"), &Connection.Reuse, false);
  Add(_T("Connection"), _T("SendBuffer"), &Connection.SendBuffer, 8 * Kilo, 1,
      0, 64 * Kilo, _T(" B"));
  Add(_T("Connection"), _T("SkipWANIPSetup"), &Connection.SkipWANIPSetup,
      false);
  Add(_T("Connection"), _T("SkipWANPPPSetup"), &Connection.SkipWANPPPSetup,
      false);
  Add(_T("Connection"), _T("SlowConnect"), &Connection.SlowConnect, false);
  Add(_T("Connection"), _T("TimeoutConnect"), &Connection.TimeoutConnect,
      16 * 1000, 1000, 1, 2 * 60, _T(" s"));
  Add(_T("Connection"), _T("TimeoutHandshake"), &Connection.TimeoutHandshake,
      45 * 1000, 1000, 1, 5 * 60, _T(" s"));
  Add(_T("Connection"), _T("TimeoutTraffic"), &Connection.TimeoutTraffic,
      140 * 1000, 1000, 10, 60 * 60, _T(" s"));
  Add(_T("Connection"), _T("UPnPRefreshTime"), &Connection.UPnPRefreshTime,
      30 * 60 * 1000, 60 * 1000, 5, 24 * 60, _T(" m"));
  Add(_T("Connection"), _T("UPnPTimeout"), &Connection.UPnPTimeout, 5 * 1000, 1,
      0, 60 * 1000, _T(" ms"));
  Add(_T("Connection"), _T("ZLibCompressionLevel"),
      &Connection.ZLibCompressionLevel, 9, 1, 0, 9, _T(" level"));
  Add(_T("Connection"), _T("IgnoredCountry"), &Connection.IgnoredCountry,
      _T("|TW|HK|CN|"));
  Add(_T("Connection"), _T("EnableMulticast"), &Connection.EnableMulticast,
      true);
  Add(_T("Connection"), _T("MulticastLoop"), &Connection.MulticastLoop, false);
  Add(_T("Connection"), _T("MulticastTTL"), &Connection.MulticastTTL, 1, 1, 0,
      255);
#ifdef LAN_MODE
  Add(_T("Connection"), _T("EnableBroadcast"), &Connection.EnableBroadcast,
      true);
#else  // LAN_MODE
  Add(_T("Connection"), _T("EnableBroadcast"), &Connection.EnableBroadcast,
      false);
  ...
  Add(_T("Bandwidth"), _T("HubIn"), &Bandwidth.HubIn, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("HubOut"), &Bandwidth.HubOut, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("LeafIn"), &Bandwidth.LeafIn, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("LeafOut"), &Bandwidth.LeafOut, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("PeerIn"), &Bandwidth.PeerIn, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("PeerOut"), &Bandwidth.PeerOut, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("Request"), &Bandwidth.Request, 32 * 128, 128, 0,
      8192, _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("UdpOut"), &Bandwidth.UdpOut, 0, 128, 0, 8192,
      _T(" Kb/s"));
  Add(_T("Bandwidth"), _T("Uploads"), &Bandwidth.Uploads, 0);

  Add(_T("Community"), _T("AwayMessageIdleTime"),
      &Community.AwayMessageIdleTime, 20 * 60, 60, 5, 60, _T(" m"));
  ...
  Add(_T("Community"), _T("UserPanelSize"), &Community.UserPanelSize, 200, 1, 0,
      1024, _T(" px"));

  Add(_T("Discovery"), _T("AccessThrottle"), &Discovery.AccessThrottle, 60 * 60,
      60, 1, 180, _T(" m"));
  Add(_T("Discovery"), _T("BootstrapCount"), &Discovery.BootstrapCount, 10, 1,
      0, 20);
  Add(_T("Discovery"), _T("CacheCount"), &Discovery.CacheCount, 50, 1, 1, 256);
  Add(_T("Discovery"), _T("DefaultUpdate"), &Discovery.DefaultUpdate, 60 * 60,
      60, 1, 60 * 24, _T(" m"));
  Add(_T("Discovery"), _T("FailureLimit"), &Discovery.FailureLimit, 2, 1, 1,
      512);
  Add(_T("Discovery"), _T("Lowpoint"), &Discovery.Lowpoint, 10, 1, 1, 512);
  Add(_T("Discovery"), _T("AccessPeriod"), &Discovery.AccessPeriod, 30 * 60, 60,
      1, 60 * 24, _T(" m"));

  Add(_T("Gnutella"), _T("ConnectFactor"), &Gnutella.ConnectFactor, 4, 1, 1, 20,
      _T("x"));
  Add(_T("Gnutella"), _T("ConnectThrottle"), &Gnutella.ConnectThrottle, 30, 1,
      0, 60 * 60, _T(" s"));
  ...
  Add(_T("Gnutella"), _T("HitsPerPacket"), &Gnutella.HitsPerPacket, 8, 1, 1, 8,
      _T(" files"));
  Add(_T("Gnutella"), _T("HostCacheSize"), &Gnutella.HostCacheSize, 1024, 1, 32,
      16384, _T(" hosts"));
  Add(_T("Gnutella"), _T("HostCacheView"), &Gnutella.HostCacheView,
      PROTOCOL_ED2K);
  Add(_T("Gnutella"), _T("MaxHits"), &Gnutella.MaxHits, 64, 1, 0, 4096,
      _T(" files"));
  Add(_T("Gnutella"), _T("MaximumPacket"), &Gnutella.MaximumPacket, 64 * Kilo,
      Kilo, 32, 256, _T(" KB"));
  Add(_T("Gnutella"), _T("MaxResults"), &Gnutella.MaxResults, 150, 1, 1, 300,
      _T(" hits"));
  Add(_T("Gnutella"), _T("RouteCache"), &Gnutella.RouteCache, 600, 60, 1, 120,
      _T(" m"));
  Add(_T("Gnutella"), _T("SpecifyProtocol"), &Gnutella.SpecifyProtocol, true);

  Add(_T("Gnutella1"), _T("ClientMode"), &Gnutella1.ClientMode, MODE_LEAF, 1,
      MODE_AUTO, MODE_HUB);
  ...
  Add(_T("Gnutella1"), _T("EnableOOB"), &Gnutella1.EnableOOB,
      false); // TODO: Change this to "true" after OOB fully implemented.
  Add(_T("Gnutella1"), _T("HostCount"), &Gnutella1.HostCount, 15, 1, 1, 50);
  Add(_T("Gnutella1"), _T("HostExpire"), &Gnutella1.HostExpire,
      2 * 24 * 60 * 60, 24 * 60 * 60, 1, 100, _T(" d"));
  Add(_T("Gnutella1"), _T("MaxHostsInPongs"), &Gnutella1.MaxHostsInPongs, 10, 1,
      5, 30);
  Add(_T("Gnutella1"), _T("MaximumQuery"), &Gnutella1.MaximumQuery, 256, 1, 32,
      262144);
  Add(_T("Gnutella1"), _T("MaximumTTL"), &Gnutella1.MaximumTTL, 10, 1, 1, 10);
  Add(_T("Gnutella1"), _T("MCastPingRate"), &Gnutella1.MCastPingRate, 60 * 1000,
      1000, 60, 60 * 60, _T(" s"));
  Add(_T("Gnutella1"), _T("NumHubs"), &Gnutella1.NumHubs, 3, 1, 1, 5);
  Add(_T("Gnutella1"), _T("NumLeafs"), &Gnutella1.NumLeafs, 50, 1, 5, 1024);
  Add(_T("Gnutella1"), _T("NumPeers"), &Gnutella1.NumPeers, 32, 1, 15,
      64); // For X-Degree
  Add(_T("Gnutella1"), _T("PacketBufferSize"), &Gnutella1.PacketBufferSize, 64,
      1, 1, 1024, _T(" packets"));
  Add(_T("Gnutella1"), _T("PacketBufferTime"), &Gnutella1.PacketBufferTime,
      60000, 1000, 10, 180, _T(" s"));
  Add(_T("Gnutella1"), _T("PingFlood"), &Gnutella1.PingFlood, 3000, 1000, 0, 30,
      _T(" s"));
  Add(_T("Gnutella1"), _T("PingRate"), &Gnutella1.PingRate, 30000, 1000, 15,
      180, _T(" s"));
  Add(_T("Gnutella1"), _T("PongCache"), &Gnutella1.PongCache, 10000, 1000, 1,
      180, _T(" s"));
  Add(_T("Gnutella1"), _T("PongCount"), &Gnutella1.PongCount, 10, 1, 1, 64);
  Add(_T("Gnutella1"), _T("QueryGlobalThrottle"),
      &Gnutella1.QueryGlobalThrottle, 60 * 1000, 1000, 60, 60 * 60, _T(" s"));
  ...
  Add(_T("Gnutella1"), _T("QueryThrottle"), &Gnutella1.QueryThrottle, 120, 1,
      30, 60 * 60, _T(" s"));
  ...
  Add(_T("Gnutella2"), _T("HAWPeriod"), &Gnutella2.HAWPeriod, 5 * 60 * 1000,
      1000, 1, 60 * 60, _T(" s"));
  Add(_T("Gnutella2"), _T("HostCurrent"), &Gnutella2.HostCurrent, 10 * 60, 60,
      1, 24 * 60, _T(" m"));
  Add(_T("Gnutella2"), _T("HostCount"), &Gnutella2.HostCount, 15, 1, 1, 50);
  Add(_T("Gnutella2"), _T("HostExpire"), &Gnutella2.HostExpire,
      2 * 24 * 60 * 60, 24 * 60 * 60, 1, 100, _T(" d"));
  Add(_T("Gnutella2"), _T("HubHorizonSize"), &Gnutella2.HubHorizonSize, 128, 1,
      32, 512);
  Add(_T("Gnutella2"), _T("HubVerified"), &Gnutella2.HubVerified, false);
  Add(_T("Gnutella2"), _T("KHLHubCount"), &Gnutella2.KHLHubCount, 50, 1, 1,
      256);
  Add(_T("Gnutella2"), _T("KHLPeriod"), &Gnutella2.KHLPeriod, 60 * 1000, 1000,
      1, 60 * 60, _T(" s"));
  Add(_T("Gnutella2"), _T("LNIPeriod"), &Gnutella2.LNIPeriod, 60 * 1000, 1000,
      1, 60 * 60, _T(" s"));
#ifdef LAN_MODE
  ...
  Add(_T("Gnutella2"), _T("NumLeafs"), &Gnutella2.NumLeafs, 300, 1, 50,
      0x7FFFFFFF);
  Add(_T("Gnutella2"), _T("NumPeers"), &Gnutella2.NumPeers, 6, 1, 4, 64);
#endif // LAN_MODE
  Add(_T("Gnutella2"), _T("PingRate"), &Gnutella2.PingRate, 15000, 1000, 5, 180,
      _T(" s"));
  Add(_T("Gnutella2"), _T("PingRelayLimit"), &Gnutella2.PingRelayLimit, 10, 1,
      10, 30);
  Add(_T("Gnutella2"), _T("QueryGlobalThrottle"),
      &Gnutella2.QueryGlobalThrottle, 125, 1, 1, 60 * 1000, _T(" ms"));
  Add(_T("Gnutella2"), _T("QueryHostDeadline"), &Gnutella2.QueryHostDeadline,
      10 * 60, 1, 1, 120 * 60, _T(" s"));
  Add(_T("Gnutella2"), _T("QueryThrottle"), &Gnutella2.QueryThrottle, 120, 1,
      30, 60 * 60, _T(" s"));
  Add(_T("Gnutella2"), _T("QueryLimit"), &Gnutella2.QueryLimit, 2400, 1, 0,
      10000);
  Add(_T("Gnutella2"), _T("RequeryDelay"), &Gnutella2.RequeryDelay, 4 * 60 * 60,
      60 * 60, 1, 24, _T(" h"));
  Add(_T("Gnutella2"), _T("UdpBuffers"), &Gnutella2.UdpBuffers, 512, 1, 16,
      2048);
  Add(_T("Gnutella2"), _T("UdpGlobalThrottle"), &Gnutella2.UdpGlobalThrottle, 1,
      1, 0, 10000);
  Add(_T("Gnutella2"), _T("UdpInExpire"), &Gnutella2.UdpInExpire, 30000, 1000,
      1, 300, _T(" s"));
  Add(_T("Gnutella2"), _T("UdpInFrames"), &Gnutella2.UdpInFrames, 256, 1, 16,
      2048);
  Add(_T("Gnutella2"), _T("UdpMTU"), &Gnutella2.UdpMTU, 500, 1, 16, 10 * Kilo,
      _T(" B"));
  Add(_T("Gnutella2"), _T("UdpOutExpire"), &Gnutella2.UdpOutExpire, 26000, 1000,
      1, 300, _T(" s"));
  Add(_T("Gnutella2"), _T("UdpOutFrames"), &Gnutella2.UdpOutFrames, 256, 1, 16,
      2048);
  Add(_T("Gnutella2"), _T("UdpOutResend"), &Gnutella2.UdpOutResend, 6000, 1000,
      1, 300, _T(" s"));

  Add(_T("eDonkey"), _T("CloseNeighboursOnConnect"),
      &eDonkey.CloseNeighboursOnConnect, true);
  Add(_T("eDonkey"), _T("DefaultServerFlags"), &eDonkey.DefaultServerFlags,
      0xFFFFFFFF);
  Add(_T("eDonkey"), _T("DequeueTime"), &eDonkey.DequeueTime, 3600, 60, 2, 512,
      _T(" m"));
  Add(_T("eDonkey"), _T("EnableAlways"), &eDonkey.EnableAlways, false);
  Add(_T("eDonkey"), _T("Endgame"), &eDonkey.Endgame, true);
  Add(_T("eDonkey"), _T("ExtendedRequest"), &eDonkey.ExtendedRequest, 2, 1, 0,
      2);
  Add(_T("eDonkey"), _T("FastConnect"), &eDonkey.FastConnect, false);
  Add(_T("eDonkey"), _T("ForceHighID"), &eDonkey.ForceHighID, true);
  Add(_T("eDonkey"), _T("FrameSize"), &eDonkey.FrameSize, 10 * Kilo, Kilo, 1,
      Kilo, _T(" KB"));
  Add(_T("eDonkey"), _T("GetSourcesThrottle"), &eDonkey.GetSourcesThrottle,
      8 * 60 * 60 * 1000, 60 * 60 * 1000, 1, 24, _T(" h"));
  ...
  Add(_T("eDonkey"), _T("LearnNewServersClient"),
      &eDonkey.LearnNewServersClient, false);
  ...
  Add(_T("eDonkey"), _T("MaxShareCount"), &eDonkey.MaxShareCount, 1000, 1, 25,
      20000);
  Add(_T("eDonkey"), _T("MinServerFileSize"), &eDonkey.MinServerFileSize, 0, 1,
      0, 50, _T(" MB"));
  Add(_T("eDonkey"), _T("NumServers"), &eDonkey.NumServers, 1, 1, 0, 1);
  Add(_T("eDonkey"), _T("PacketThrottle"), &eDonkey.PacketThrottle, 500, 1, 250,
      5000, _T(" ms"));
  Add(_T("eDonkey"), _T("QueryFileThrottle"), &eDonkey.QueryFileThrottle,
      60 * 60 * 1000, 60 * 1000, 30, 120, _T(" m"));
  Add(_T("eDonkey"), _T("QueryGlobalThrottle"), &eDonkey.QueryGlobalThrottle,
      1000, 1, 1000, 20000, _T(" ms"));
  Add(_T("eDonkey"), _T("QueryThrottle"), &eDonkey.QueryThrottle, 120, 1, 60,
      60 * 60, _T(" s"));
  Add(_T("eDonkey"), _T("QueueRankThrottle"), &eDonkey.QueueRankThrottle,
      2 * 60 * 1000, 1000, 60, 600, _T(" s"));
  Add(_T("eDonkey"), _T("ReAskTime"), &eDonkey.ReAskTime, 29 * 60, 60, 20, 360,
      _T(" m"));
  Add(_T("eDonkey"), _T("RequestPipe"), &eDonkey.RequestPipe, 3, 1, 1, 10);
  Add(_T("eDonkey"), _T("RequestSize"), &eDonkey.RequestSize, 90 * Kilo, Kilo,
      10, Kilo, _T(" KB"));
  Add(_T("eDonkey"), _T("SendPortServer"), &eDonkey.SendPortServer, false);
  Add(_T("eDonkey"), _T("ServerListURL"), &eDonkey.ServerListURL,
      _T("http://upd.emule-security.org/server.met"));
  Add(_T("eDonkey"), _T("ServerWalk"), &eDonkey.ServerWalk, true);
  Add(_T("eDonkey"), _T("SourceThrottle"), &eDonkey.SourceThrottle, 1000, 1,
      250, 5000, _T(" ms"));
  Add(_T("eDonkey"), _T("StatsGlobalThrottle"), &eDonkey.StatsGlobalThrottle,
      30 * 60 * 1000, 60 * 1000, 30, 120, _T(" m"));
  Add(_T("eDonkey"), _T("StatsServerThrottle"), &eDonkey.StatsServerThrottle,
      4 * 60 * 60, 60, 1, 7 * 24 * 60, _T(" m"));
  Add(_T("eDonkey"), _T("AutoDiscovery"), &eDonkey.AutoDiscovery, true);

  Add(_T("DC"), _T("DequeueTime"), &DC.DequeueTime, 5 * 60 * 1000, 1000, 2 * 60,
      60 * 60, _T(" s"));
  Add(_T("DC"), _T("EnableAlways"), &DC.EnableAlways, false);
  Add(_T("DC"), _T("NumServers"), &DC.NumServers, 1, 1, 0, 5);
  Add(_T("DC"), _T("QueryThrottle"), &DC.QueryThrottle, 2 * 60, 1, 30, 60 * 60,
      _T(" s"));
  Add(_T("DC"), _T("ReAskTime"), &DC.ReAskTime, 60 * 1000, 1000, 30, 60 * 60,
      _T(" s"));
  ...
  Add(_T("BitTorrent"), _T("BandwidthPercentage"),
      &BitTorrent.BandwidthPercentage, 80, 1, 50, 95, _T(" %"));
  Add(_T("BitTorrent"), _T("ClearRatio"), &BitTorrent.ClearRatio, 120, 1, 100,
      999, _T(" %"));
  Add(_T("BitTorrent"), _T("ConnectThrottle"), &BitTorrent.ConnectThrottle,
      6 * 60, 1, 0, 60 * 60, _T(" s"));
  Add(_T("BitTorrent"), _T("DefaultTracker"), &BitTorrent.DefaultTracker,
      _T("udp://tracker.openbittorrent.com:80"));
  Add(_T("BitTorrent"), _T("DefaultTrackerPeriod"),
      &BitTorrent.DefaultTrackerPeriod, 5 * 60000, 60000, 5, 120, _T(" m"));
  Add(_T("BitTorrent"), _T("DownloadConnections"),
      &BitTorrent.DownloadConnections, 40, 1, 1, 800);
  ...
  Add(_T("BitTorrent"), _T("HostExpire"), &BitTorrent.HostExpire,
      2 * 24 * 60 * 60, 24 * 60 * 60, 1, 100, _T(" d"));
  Add(_T("BitTorrent"), _T("LinkPing"), &BitTorrent.LinkPing, 120 * 1000, 1000,
      10, 60 * 10, _T(" s"));
  Add(_T("BitTorrent"), _T("LinkTimeout"), &BitTorrent.LinkTimeout, 180 * 1000,
      1000, 10, 60 * 10, _T(" s"));
  Add(_T("BitTorrent"), _T("PeerID"), &BitTorrent.PeerID, _T(""));
  Add(_T("BitTorrent"), _T("PreferenceBTSources"),
      &BitTorrent.PreferenceBTSources, true);
  Add(_T("BitTorrent"), _T("QueryHostDeadline"), &BitTorrent.QueryHostDeadline,
      30, 1, 1, 60 * 60, _T(" s"));
  Add(_T("BitTorrent"), _T("RandomPeriod"), &BitTorrent.RandomPeriod, 30 * 1000,
      1000, 1, 60 * 5, _T(" s"));
  Add(_T("BitTorrent"), _T("RequestLimit"), &BitTorrent.RequestLimit,
      128 * Kilo, Kilo, 1, 1024, _T(" KB"));
  Add(_T("BitTorrent"), _T("RequestPipe"), &BitTorrent.RequestPipe, 4, 1, 1,
      10);
  Add(_T("BitTorrent"), _T("RequestSize"), &BitTorrent.RequestSize, 16 * Kilo,
      Kilo, 8, 128, _T(" KB"));
  Add(_T("BitTorrent"), _T("SourceExchangePeriod"),
      &BitTorrent.SourceExchangePeriod, 10, 1, 1, 60 * 5, _T(" m"));
  Add(_T("BitTorrent"), _T("TorrentCodePage"), &BitTorrent.TorrentCodePage, 0,
      1, 0, 9999999);
  Add(_T("BitTorrent"), _T("TorrentCreatorPath"),
      &BitTorrent.TorrentCreatorPath);
  Add(_T("BitTorrent"), _T("TrackerKey"), &BitTorrent.TrackerKey, true);
  Add(_T("BitTorrent"), _T("UploadCount"), &BitTorrent.UploadCount, 4, 1, 2,
      16);
  Add(_T("BitTorrent"), _T("UtPexPeriod"), &BitTorrent.UtPexPeriod, 60 * 1000,
      1000, 10, 60 * 10, _T(" s"));

  Add(_T("Downloads"), _T("AllowBackwards"), &Downloads.AllowBackwards, true);
  Add(_T("Downloads"), _T("AllowFirstAttempt"),
      &Downloads.AllowUnlimitedFirstAttempt, false);
  ...
  Add(_T("Downloads"), _T("BufferSize"), &Downloads.BufferSize, 80 * Kilo, Kilo,
      0, 512, _T(" KB"));
  Add(_T("Downloads"), _T("ChunkSize"), &Downloads.ChunkSize, 512 * Kilo, Kilo,
      0, 10 * Kilo, _T(" KB"));
  Add(_T("Downloads"), _T("ChunkStrap"), &Downloads.ChunkStrap, 128 * Kilo,
      Kilo, 0, 10 * Kilo, _T(" KB"));
  Add(_T("Downloads"), _T("ClearDelay"), &Downloads.ClearDelay, 30 * 1000, 1000,
      1, 30 * 60, _T(" s"));
  Add(_T("Downloads"), _T("ClearSourcesAfter"), &Downloads.ClearSourcesAfter,
      true);
  Add(_T("Downloads"), _T("CollectionPath"), &Downloads.CollectionPath);
  Add(_T("Downloads"), _T("CompletePath"), &Downloads.CompletePath);
  Add(_T("Downloads"), _T("ConnectThrottle"), &Downloads.ConnectThrottle, 250,
      1, 0, 5000, _T(" ms"));
  ...
  Add(_T("Downloads"), _T("CountOnlyWithSources"),
      &Downloads.CountOnlyWithSources, false);
  Add(_T("Downloads"), _T("MaxAllowedFailures"), &Downloads.MaxAllowedFailures,
      10, 1, 3, 40);
  Add(_T("Downloads"), _T("MaxConnectingSources"),
      &Downloads.MaxConnectingSources, 28, 1, 5, 50);
  Add(_T("Downloads"), _T("MaxFileSearches"), &Downloads.MaxFileSearches, 2, 1,
      0, 5);
  ...
  Add(_T("Downloads"), _T("MaxTransfers"), &Downloads.MaxTransfers, 100, 1, 1,
      250);
  Add(_T("Downloads"), _T("Metadata"), &Downloads.Metadata, true);
  Add(_T("Downloads"), _T("MediaBuffer"), &Downloads.MediaBuffer, 20 * 1000,
      1000, 0, 180, _T(" s"));
  Add(_T("Downloads"), _T("MinSources"), &Downloads.MinSources, 3, 1, 0, 6);
  Add(_T("Downloads"), _T("NeverDrop"), &Downloads.NeverDrop, false);
  Add(_T("Downloads"), _T("PushTimeout"), &Downloads.PushTimeout, 45 * 1000,
      1000, 5, 180, _T(" s"));
  ...
  Add(_T("Downloads"), _T("RetryDelay"), &Downloads.RetryDelay, 10 * 60 * 1000,
      1000, 120, 60 * 60, _T(" s"));
  Add(_T("Downloads"), _T("SaveInterval"), &Downloads.SaveInterval, 60 * 1000,
      1000, 1, 120, _T(" s"));
  Add(_T("Downloads"), _T("SearchPeriod"), &Downloads.SearchPeriod, 120 * 1000,
      1000, 10, 4 * 60, _T(" s"));
  ...
  Add(_T("Downloads"), _T("SourcesWanted"), &Downloads.SourcesWanted, 500, 1,
      50, 5000);
  Add(_T("Downloads"), _T("SparseThreshold"), &Downloads.SparseThreshold,
      8 * Kilo, Kilo, 0, 256, _T(" MB"));
  Add(_T("Downloads"), _T("StaggardStart"), &Downloads.StaggardStart, false);
  Add(_T("Downloads"), _T("StarveGiveUp"), &Downloads.StarveGiveUp, 3, 1, 3,
      120, _T(" h"));
  Add(_T("Downloads"), _T("StarveTimeout"), &Downloads.StarveTimeout,
      45 * 60 * 1000, 60 * 1000, 45, 24 * 60, _T(" m"));
  ...
  Add(_T("Downloads"), _T("WebHookExtensions"), &Downloads.WebHookExtensions,
      _T("|zip|7z|gz|rar|r0|tgz|ace|z|tar|arj|lzh|sit|hqx|fml|grs|mp3|iso|msi|")
      _T("exe|bin|"));

  Add(_T("Uploads"), _T("AllowBackwards"), &Uploads.AllowBackwards, true);
  Add(_T("Uploads"), _T("AutoClear"), &Uploads.AutoClear, false);
  Add(_T("Uploads"), _T("BlockAgents"), &Uploads.BlockAgents,
      _T("|Mozilla|Foxy|Fake Shareaza|"));
  Add(_T("Uploads"), _T("ClampdownFactor"), &Uploads.ClampdownFactor, 20, 1, 0,
      100, _T("%"));
  Add(_T("Uploads"), _T("ClampdownFloor"), &Uploads.ClampdownFloor, 8 * 128,
      128, 0, 4096, _T(" Kb/s"));
  Add(_T("Uploads"), _T("ClearDelay"), &Uploads.ClearDelay, 30 * 1000, 1000, 1,
      1800, _T(" s"));
  Add(_T("Uploads"), _T("DynamicPreviews"), &Uploads.DynamicPreviews, true);
  Add(_T("Uploads"), _T("FilterMask"), &Uploads.FilterMask, 0xFFFFFFFD);
  Add(_T("Uploads"), _T("FreeBandwidthFactor"), &Uploads.FreeBandwidthFactor,
      15, 1, 0, 100, _T("%"));
  Add(_T("Uploads"), _T("FreeBandwidthValue"), &Uploads.FreeBandwidthValue,
      20 * 128, 128, 0, 4096, _T(" Kb/s"));
  Add(_T("Uploads"), _T("HubUnshare"), &Uploads.HubUnshare, true);
  Add(_T("Uploads"), _T("MaxPerHost"), &Uploads.MaxPerHost, 2, 1, 1, 64);
  Add(_T("Uploads"), _T("PreviewQuality"), &Uploads.PreviewQuality, 75, 1, 5,
      100, _T("%"));
  Add(_T("Uploads"), _T("PreviewTransfers"), &Uploads.PreviewTransfers, 3, 1, 1,
      64);
  Add(_T("Uploads"), _T("QueuePollMax"), &Uploads.QueuePollMax, 120 * 1000,
      1000, 30, 180, _T(" s"));
  Add(_T("Uploads"), _T("QueuePollMin"), &Uploads.QueuePollMin, 45 * 1000, 1000,
      0, 60, _T(" s"));
  Add(_T("Uploads"), _T("RewardQueuePercentage"),
      &Uploads.RewardQueuePercentage, 10, 1, 0, 99, _T("%"));
  Add(_T("Uploads"), _T("RotateChunkLimit"), &Uploads.RotateChunkLimit, Mega,
      Kilo, 0, 10 * Kilo, _T(" KB"));
  ...
  Add(_T("Experimental"), _T("EnableDIPPSupport"),
      &Experimental.EnableDIPPSupport, false);
  Add(_T("Experimental"), _T("TestBTPartials"), &Experimental.TestBTPartials,
      false);
  ...
  if (General.Path.IsEmpty() || !PathFileExists(General.Path)) {
    ...
    if (!PathFileExists(General.Path)) {
      General.Path =
          theApp.GetProgramFilesFolder64() + _T( "\\" ) CLIENT_NAME_T;
      if (!PathFileExists(General.Path)) {
        General.Path = theApp.m_strBinaryPath.Left(
            theApp.m_strBinaryPath.ReverseFind('\\'));
      }
    }
  }
  ...
  if (Downloads.IncompletePath.IsEmpty() ||
    ...
    Downloads.IncompletePath = theApp.GetLocalAppDataFolder() +
                               _T("\\") CLIENT_NAME_T _T("\\Incomplete");
    CreateDirectory(Downloads.IncompletePath);
  }
  ...
  CString sTorrent;
  GetFullPathName(BitTorrent.TorrentCreatorPath, MAX_PATH,
                  sTorrent.GetBuffer(MAX_PATH), NULL);
  sTorrent.ReleaseBuffer();
  BitTorrent.TorrentCreatorPath = sTorrent;
  if (BitTorrent.TorrentCreatorPath.IsEmpty() ||
      !PathFileExists(BitTorrent.TorrentCreatorPath)) {
  ...
  if (General.Upgrade) {
    ...
    if (PathFileExists(strInstaller)) {
      ...
      CFileFind ff;
      BOOL res = ff.FindFile(Downloads.CompletePath + _T("\\") MOD_CLIENT_NAME_T
                                                      _T("_*.exe"));
      while (res) {
        res = ff.FindNextFile();
      ...
      CString strNewPath =
          Downloads.CompletePath + _T("\\") + PathFindFileName(strInstaller);
  ...
  if (Live.FirstRun) {
    ...
    if (IsDefault(&General.Language)) {
      CString strDefaultLanguage =
          CRegistry::GetString(NULL, _T("DefaultLanguage"));
      if (!strDefaultLanguage.IsEmpty()) {
        General.Language = strDefaultLanguage;
        General.LanguageRTL =
            CRegistry::GetDword(NULL, _T("DefaultLanguageRTL")) != 0;
      }
    }
  }
  ...
  BitTorrent.DownloadTorrents =
      min(BitTorrent.DownloadTorrents, (GetOutgoingBandwidth() / 2u + 2u));

  // Enforce a few sensible values to avoid being banned/dropped/etc (in case of
  // registry fiddling)
  Downloads.ConnectThrottle =
      max(Downloads.ConnectThrottle, Connection.ConnectThrottle + 50u);
  ...
  // UPnP will setup a random port, so we need to reset values after it sets
  // Connection.InPort
  ...
  if (Live.FirstRun)
    OnChangeConnectionSpeed(); // This helps if the QuickStart Wizard is
                               // skipped.
}
...
void CSettings::SmartUpgrade() {
  ...
  if (General.SmartVersion < SMART_VERSION) {
    ...
    // 'SmartUpgrade' settings updates- change any settings that were mis-set in
    // previous versions
    ...
    if (General.SmartVersion < 29) {
      ...
      Gnutella2.RequeryDelay =
          4 * 3600; // Longer delay between sending same search to G2 hub
    }

    if (General.SmartVersion < 30) {
      BitTorrent.RequestSize =
          16384; // Other BT clients have changed this value (undocumented)
    }
    ...
    if (General.SmartVersion < 31) {
      ...
      Uploads.QueuePollMin =
          45000; // Lower values for re-ask times- a dynamic multiplier
      Uploads.QueuePollMax =
          120000; //  Is now applied based on Q# (from 1x to 5x)
      eDonkey.PacketThrottle = 500; // Second throttle added for finer control
    }

    if (General.SmartVersion < 32) {
      theApp.WriteProfileString(_T("Interface"), _T("SchemaColumns.audio"),
                                _T("(EMPTY)"));
    }

    if (General.SmartVersion < 33) {
      RegDeleteKey(HKEY_CURRENT_USER,
                   REGISTRY_KEY _T("\\Plugins\\LibraryBuilder"));
    }
    ...
    if (General.SmartVersion < 37) {
      ...
      Search.FilterMask =
          Search.FilterMask | 0x140; // Turn on DRM and Suspicious filters
    }
    ...
    if (General.SmartVersion < 50) {
      CString strExts = theApp.GetProfileString(
          L"Plugins", L"{04CC76C7-1ED7-4CAE-9762-B8664ED008ED}");
      if (strExts.GetLength() > 0 && strExts.GetAt(0) == '|') {
        if (_tcsistr(strExts, L"|.3gp|") == NULL &&
            _tcsistr(strExts, L"|-.3gp|") == NULL)
          strExts += L"|.3gp|";
        if (_tcsistr(strExts, L"|.3gpp|") == NULL &&
            _tcsistr(strExts, L"|-.3gpp|") == NULL)
          strExts += L"|.3gpp|";
        if (_tcsistr(strExts, L"|.3g2|") == NULL &&
            _tcsistr(strExts, L"|-.3g2|") == NULL)
          strExts += L"|.3g2|";
        if (_tcsistr(strExts, L"|.dv|") == NULL &&
            _tcsistr(strExts, L"|-.dv|") == NULL)
          strExts += L"|.dv|";
        if (_tcsistr(strExts, L"|.flv|") == NULL &&
            _tcsistr(strExts, L"|-.flv|") == NULL)
          strExts += L"|.flv|";
        if (_tcsistr(strExts, L"|.ivf|") == NULL &&
            _tcsistr(strExts, L"|-.ivf|") == NULL)
          strExts += L"|.ivf|";
        if (_tcsistr(strExts, L"|.gvi|") == NULL &&
            _tcsistr(strExts, L"|-.gvi|") == NULL)
          strExts += L"|.gvi|";
        if (_tcsistr(strExts, L"|.mpe|") == NULL &&
            _tcsistr(strExts, L"|-.mpe|") == NULL)
          strExts += L"|.mpe|";
        if (_tcsistr(strExts, L"|.wm|") == NULL &&
            _tcsistr(strExts, L"|-.wm|") == NULL)
          strExts += L"|.wm|";
        if (_tcsistr(strExts, L"|.rmvb|") == NULL &&
            _tcsistr(strExts, L"|-.rmvb|") == NULL)
          strExts += L"|.rmvb|";
        if (_tcsistr(strExts, L"|.mp4|") == NULL &&
            _tcsistr(strExts, L"|-.mp4|") == NULL)
          strExts += L"|.mp4|";
        theApp.WriteProfileString(
            L"Plugins", L"{04CC76C7-1ED7-4CAE-9762-B8664ED008ED}", strExts);
      } else {
        // the value is missing or it was REG_DWORD as in earlier versions
        strExts = L"|.asf||.asx||.avi||.divx||.m2v||.m2p||.mkv||.mov||.mpeg||."
                  L"mpg||.ogm||.qt||.ram||.rm||.vob||.wmv||.xvid||.mp4||.rmvb||"
                  L".3gp||.3gpp||.3g2||.dv||.flv||.ivf||.gvi||.mpe||.nsv||.wm|";
        theApp.WriteProfileString(
            L"Plugins", L"{04CC76C7-1ED7-4CAE-9762-B8664ED008ED}", strExts);
      }
      strExts = theApp.GetProfileString(
          L"Plugins", L"{570C197C-FE9C-4D1F-B6E0-EFA44D36399F}");
      if (strExts.GetLength() > 0 && strExts.GetAt(0) == '|') {
        if (_tcsistr(strExts, L"|.3gp|") == NULL &&
            _tcsistr(strExts, L"|-.3gp|") == NULL)
          strExts += L"|.3gp|";
        ...
        if (_tcsistr(strExts, L"|.mp4|") == NULL &&
          ...
          strExts += L"|.mp4|";
        theApp.WriteProfileString(
            L"Plugins", L"{570C197C-FE9C-4D1F-B6E0-EFA44D36399F}", strExts);
      } else {
        strExts = L"|.asf||.asx||.avi||.divx||.m2v||.m2p||.mkv||.mov||.mpeg||."
                  L"mpg||.ogm||.qt||.ram||.rm||.vob||.wmv||.xvid||.mp4||.rmvb||"
                  L".3gp||.3gpp||.3g2||.dv||.flv||.ivf||.gvi||.mpe||.nsv||.wm|";
    ...
    if (General.SmartVersion < 57) {
      // Delete old values
      SHDeleteValue(HKEY_CURRENT_USER, REGISTRY_KEY _T("\\Toolbars"),
                    _T("CRemoteWnd"));
    }
...
void CSettings::OnChangeConnectionSpeed() {
  ...
  if (Connection.InSpeed <= 80) { // NT Modem users / Win9x Modem users
    ...
    Search.GeneralThrottle =
        300; // Slow searches a little so we don't get flooded

    Gnutella2.NumLeafs = 50;
    BitTorrent.DownloadTorrents = 1;      // Best not to try too many torrents
  } else if (Connection.InSpeed <= 256) { // IDSN, Dual modems, etc
    ...
    Search.GeneralThrottle =
        250; // Slow searches a little so we don't get flooded

    Gnutella2.NumLeafs = 200;
    BitTorrent.DownloadTorrents = 3;
  } else if (Connection.InSpeed <= 768) { // Slower broadband
    ...
    BitTorrent.DownloadTorrents = 3;
  } else if (Connection.InSpeed <= 2500 || bLimited) { // Fast broadband
  ...
  } else if (Connection.InSpeed <= 5000) { // Very high capacity connection
    ...
    BitTorrent.DownloadTorrents =
        5; // Should be able to handle several torrents
  } else {
    ...
    if (Connection.InSpeed <= 10000) {
      ...
      BitTorrent.DownloadTorrents =
          7; // Should be able to handle several torrents
    } else {
      Gnutella2.NumLeafs = 500; // Can probably support more leaves
      BitTorrent.DownloadTorrents =
          10; // Should be able to handle several torrents
    }
  }

  if (bLimited) { // Window XP Service Pack 2
    ...
    General.ItWasLimited = true;
  } else if (General.ItWasLimited) // We change the settings back if the user
                                   // path the half-open connection limit
  {
...
BOOL CSettings::LoadWindow(LPCTSTR pszName, CWnd *pWindow) {
  ...
  int nShowCmd =
      CRegistry::GetInt(_T("Windows"), strEntry + _T(".ShowCmd"), -1);
  if (nShowCmd == -1)
    return FALSE;
  ...
  pPos.rcNormalPosition.left =
      CRegistry::GetInt(_T("Windows"), strEntry + _T(".Left"), 0);
  pPos.rcNormalPosition.top =
      CRegistry::GetInt(_T("Windows"), strEntry + _T(".Top"), 0);
  pPos.rcNormalPosition.right =
      CRegistry::GetInt(_T("Windows"), strEntry + _T(".Right"), 0);
  pPos.rcNormalPosition.bottom =
      CRegistry::GetInt(_T("Windows"), strEntry + _T(".Bottom"), 0);
...
void CSettings::SaveWindow(LPCTSTR pszName, CWnd *pWindow) {
  ...
  CRegistry::SetInt(_T("Windows"), strEntry + _T(".Left"),
                    pPos.rcNormalPosition.left);
  CRegistry::SetInt(_T("Windows"), strEntry + _T(".Top"),
                    pPos.rcNormalPosition.top);
  CRegistry::SetInt(_T("Windows"), strEntry + _T(".Right"),
                    pPos.rcNormalPosition.right);
  CRegistry::SetInt(_T("Windows"), strEntry + _T(".Bottom"),
                    pPos.rcNormalPosition.bottom);
}
...
BOOL CSettings::LoadList(LPCTSTR pszName, CListCtrl *pCtrl, int nSort) {
  ...
  if (pHeader)
    Skin.Translate(pszName, pHeader);
...
BOOL CSettings::CheckStartup() {
  ...
  bStartup = (RegQueryValueEx(hKey, CLIENT_NAME_T, NULL, NULL, NULL, NULL) ==
              ERROR_SUCCESS);
...
void CSettings::SetStartup(BOOL bStartup) {
  ...
  if (bStartup) {
    ...
    RegSetValueEx(hKey, CLIENT_NAME_T, 0, REG_SZ,
                  (const BYTE *)(LPCTSTR)strCommand,
...
const CString CSettings::SmartSpeed(QWORD nVolume, int nVolumeUnits,
...
const CString CSettings::SmartVolume(QWORD nVolume, int nVolumeUnits,
                                     bool bTruncate) const {
  LPCTSTR szUnit =
      (!General.RatesInBytes && nVolumeUnits == bits) ? _T("b") : _T("B");
  CString strVolume;
  ...
  case Bytes:
    ...
    {
      strVolume.Format(strTruncate + _T(" K%s"), (double)nVolume / fKilo,
                       szUnit);
      break;
    }
  ...
  case KiloBytes:
    ...
    {
      strVolume.Format(strTruncate + _T(" M%s"), (double)nVolume / fKilo,
                       szUnit);
    } else {
      if (nVolume < Giga) // Giga
        strVolume.Format(strTruncate + _T(" G%s"), (double)nVolume / fMega,
                         szUnit);
      else if (nVolume < Tera) // Tera
        strVolume.Format(strTruncate + _T(" T%s"), (double)nVolume / fGiga,
                         szUnit);
      else if (nVolume < Peta) // Peta
        strVolume.Format(strTruncate + _T(" P%s"), (double)nVolume / fTera,
                         szUnit);
      else // Exa
        strVolume.Format(strTruncate + _T(" E%s"), (double)nVolume / fPeta,
                         szUnit);
    }
  }
...
QWORD CSettings::ParseVolume(const CString &strVolume, int nReturnUnits) const {
  ...
  if (strSize.Left(1) == _T("\x200E"))
    strSize = strSize.Mid(1);

  // Return early if there is no number in the string
  if (_stscanf(strSize, _T("%lf"), &val) != 1)
    return 0ul;
...
DWORD CSettings::GetOutgoingBandwidth()
    const { // This returns the available (Affected by limit) outgoing bandwidth
            // in KB/s
  if (Settings.Bandwidth.Uploads == 0)
    return (Settings.Connection.OutSpeed / 8);

  return (min((Settings.Connection.OutSpeed / 8),
              (Settings.Bandwidth.Uploads / Kilo)));
}
...
void CSettings::Item::Normalize() {
  if (!Settings.General.UnlimitedSettings && m_pDword && m_nScale &&
      m_nMin < m_nMax) {
    *m_pDword = max(min(*m_pDword, m_nMax * m_nScale), m_nMin * m_nScale);
  }
}
...
template <> void CSettings::Item::SetRange<CSliderCtrl>(CSliderCtrl &pCtrl) {
  if (m_pBool) {
    pCtrl.SetRange(0, 1);
  } else if (m_pDword) {
