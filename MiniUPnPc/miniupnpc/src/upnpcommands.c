...
UPNP_AddPortMapping(const char *controlURL, const char *servicetype,
  ...
  buffer = simpleUPnPcommand(-1, controlURL, servicetype, "AddPortMapping",
...
UPNP_AddAnyPortMapping(const char *controlURL, const char *servicetype,
  ...
  AddPortMappingArgs[7].elt = "NewLeaseDuration";
  AddPortMappingArgs[7].val = leaseDuration ? leaseDuration : "0";
  buffer = simpleUPnPcommand(-1, controlURL, servicetype, "AddAnyPortMapping",
                             AddPortMappingArgs, &bufsize);
  free(AddPortMappingArgs);
  if (!buffer) {
    return UPNPCOMMAND_HTTP_ERROR;
...
MINIUPNP_LIBSPEC int UPNP_DeletePortMapping(const char *controlURL,
  ...
  buffer = simpleUPnPcommand(-1, controlURL, servicetype, "DeletePortMapping",
...
UPNP_DeletePortMappingRange(const char *controlURL, const char *servicetype,
  ...
  buffer =
      simpleUPnPcommand(-1, controlURL, servicetype, "DeletePortMappingRange",
                        DeletePortMappingArgs, &bufsize);
  free(DeletePortMappingArgs);
  if (!buffer) {
    return UPNPCOMMAND_HTTP_ERROR;
...
MINIUPNP_LIBSPEC int UPNP_GetGenericPortMappingEntry(
  ...
  buffer = simpleUPnPcommand(-1, controlURL, servicetype,
                             "GetGenericPortMappingEntry", GetPortMappingArgs,
                             &bufsize);
...
MINIUPNP_LIBSPEC int UPNP_GetSpecificPortMappingEntry(
  ...
  buffer = simpleUPnPcommand(-1, controlURL, servicetype,
                             "GetSpecificPortMappingEntry", GetPortMappingArgs,
                             &bufsize);
  free(GetPortMappingArgs);
  if (!buffer) {
    return UPNPCOMMAND_HTTP_ERROR;
...
UPNP_GetListOfPortMappings(const char *controlURL, const char *servicetype,
  ...
  buffer =
      simpleUPnPcommand(-1, controlURL, servicetype, "GetListOfPortMappings",
